  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-16">
      <div className="max-w-md w-full bg-surface p-8 sm:p-10 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col items-center">
        ...
        {/* Status Badge */}
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-status-rejected/10 text-status-rejected border border-status-rejected/20 mb-4">
        ...
        <p className="text-sm text-on-surface-variant leading-relaxed mb-8">
          You do not have permission to view or modify this resource. Please make sure you are signed in with the correct authorized account.
        </p>
